...
<script type="text/javascript">
    ...
    var region_pemasukan=[];
    region_pemasukan['dataStr'] = '<?php echo $region_pemasukan;?>';        
    region_pemasukan['dataArray'] = JSON.parse(region_pemasukan['dataStr']);
    ...
    var mas_sales=[];
    mas_sales['dataStr'] = '<?php echo $mas_sales;?>';        
    mas_sales['dataArray'] = JSON.parse(mas_sales['dataStr']);
    ...
    drawChart(pendapatan['dataArray'],'bar','pendapatan');
    drawChart(region_pemasukan['dataArray'], 'pie','region_pemasukan');
    drawChart(total_biaya['dataArray'], 'pie','total_biaya');
    drawChart(mas_sales['dataArray'],'bar','mas_sales');
    });
...
<div class="uk-container">
    <div class="uk-child-width-1-2@s" uk-grid uk-height-match="target: > div > .uk-card">    
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-small uk-card-body" >
                <h3 class="uk-card-title">Pemasukan Bulanan seluruh Toko</h3>
                <div id="pendapatan" style="height:350px;"></div>
            </div>
        </div>
        <div>
            <div class="uk-card uk-card-default uk-card-small uk-card-body" >
                <h3 class="uk-card-title">Pemasukan Bulanan berdasarkan Wilayah</h3>
                <div id="region_pemasukan" style="height:350px;"></div>
            </div>
        </div>

        <div>
            <div class="uk-card uk-card-default uk-card-small uk-card-body" >
                <h3 class="uk-card-title">Persentase Penghasilan berdasarkan Produk</h3>
        ...
        <div>
            <div class="uk-card uk-card-default uk-card-small uk-card-body" >
                <h3 class="uk-card-title">Total Pemasukan Oleh Sales</h3>
                <div id="mas_sales" style="height:350px;"></div>
            </div>
        </div>    
